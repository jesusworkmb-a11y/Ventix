...
const PERMISOS_DEFAULT = [
  ...
  { clave: 'venta.aplicar_descuento', grupo: 'Ventas', nombre: 'Aplicar descuentos' },
  {
    ...
    grupo: 'Ventas',
    nombre: 'Autorizar descuentos y promociones que requieren aprobación',
  },
  ...
  { clave: 'compra.orden.crear', grupo: 'Compras', nombre: 'Crear órdenes de compra' },
  { clave: 'compra.orden.cancelar', grupo: 'Compras', nombre: 'Cancelar/cerrar órdenes de compra' },
  { clave: 'compra.orden.ver', grupo: 'Compras', nombre: 'Ver órdenes de compra' },
  ...
  {
    clave: 'catalogo.descuentos.gestionar',
    grupo: 'Catálogo',
    nombre: 'Gestionar descuentos y promociones',
  },
  {
